 ...
 * <p>
 * 它通过一个继承于javax.lang.model.util.ElementScanner6的NameCheckScanner类，以Visitor模式来完成对语法树的遍历
 * 分别执行visitType()、visitVariable()和visitExecutable()方法来访问类、字段和方法，这3个visit*()方法对各自的命名规则做相应的检查
...
public class NameChecker {
    ...
    /**
     * 名称检查器实现类，继承了JDK 14中新提供的ElementScanner6<br> *
    ...
    private class NameCheckScanner extends ElementScanner9<Void, Void> {
         ...
         */
        @Override
        public Void visitVariable(VariableElement e, Void p) { // 如果这个Variable是枚举或常量，则按大写命名检查，否则按照驼式命名法规则检查
